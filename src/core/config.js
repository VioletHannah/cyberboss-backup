...
function readConfig() {
  ...
  return {
    ...
    memoryIndexFile: path.join(stateDir, "memory", "index.jsonl"),
    memoryPendingFile: path.join(stateDir, "memory", "pending.jsonl"),
    memoryOpsFile: path.join(stateDir, "memory", "ops.jsonl"),
